...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"path-finding/dfs.js":[function(require,module,exports) {
"use strict";
...
var layPath = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(cell) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (!_helper.app.isFirstRun) {
              _context.next = 3;
              break;
            }

            _context.next = 3;
            return (0, _helper.delay)(_helper.app.LAYING_PATH_DURATION);

          case 3:
            cell.classList.add('path');

            _helper.app.path.push(cell);

            if (cell === _helper.app.start) {
              _helper.app.isFirstRun = false;
            } else {
  ...
  return function layPath(_x) {
    return _ref.apply(this, arguments);
  };
}();

var visitCell = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(previous, cell) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            if (!(cell && !cell.isVisited && (!cell.isWall || cell === _helper.app.target))) {
              _context2.next = 12;
              break;
            }
          ...
          case 4:
            ...
            (0, _helper.markCellVisited)(cell);

            if (!(cell === _helper.app.target)) {
              _context2.next = 10;
              break;
            }

            _helper.app.hasPath = true;
            layPath(_helper.app.target);
  ...
  return function visitCell(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

var search = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(cell) {
    var DIRECTIONS, _i, _DIRECTIONS, dir, neigh;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _i = 0, _DIRECTIONS = DIRECTIONS;

          case 2:
            if (!(_i < _DIRECTIONS.length)) {
              _context3.next = 15;
              break;
            }
          ...
          case 7:
            ...
            _context3.next = 10;
            return visitCell(cell, neigh);

          case 10:
            if (!_helper.app.hasPath) {
              _context3.next = 12;
              break;
            }
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            (0, _helper.markCellVisited)(_helper.app.start);
            _context4.next = 3;
            return search(_helper.app.start);
          ...
          case 5:
            _helper.app.removeAnimationTimeout = setTimeout(function () {
              _helper.app.board.addClass('no-animation');
            }, 2000);
...
},{"../helper":"helper.js"}],"path-finding/bfs.js":[function(require,module,exports) {
"use strict";
...
var search = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(cell) {
    var DIRECTIONS, _i, _DIRECTIONS, dir, neigh, isVisitable;
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            isVisitable = _context3.sent;

            if (isVisitable) {
              _helper.app.queue.push(neigh);
            }
          ...
          case 12:
            if (!(_helper.app.hasPath || _helper.app.queue.length <= 0)) {
              _context3.next = 14;
              break;
            }
          ...
          case 17:
            _context3.next = 19;
            return search(_helper.app.queue.shift());
...
var _default = bfs;
exports.default = _default;
},{"../helper":"helper.js"}],"manual-control.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeUserPathHead = exports.trimUserPath = exports.default = void 0;

var _helper = require("./helper");

var markCellAsHead = function markCellAsHead(cell) {
  var _app$userPathHead;

  (_app$userPathHead = _helper.app.userPathHead) === null || _app$userPathHead === void 0 ? void 0 : _app$userPathHead.classList.remove('head');
  _helper.app.userPathHead = cell;
  cell.classList.add('head');
  cell === _helper.app.target ? _helper.app.board.addClass('completed-path') : _helper.app.board.removeClass('completed-path');
};

var markCellAsUserPath = function markCellAsUserPath(cell) {
  cell.classList.add('user-path');

  if (cell !== _helper.app.start) {
    cell.previousUserPath = (0, _helper.getLast)(_helper.app.userPath);
  }

  _helper.app.userPath.push(cell);
};

var addUserPathHead = function addUserPathHead(cell) {
  markCellAsHead(cell);
  markCellAsUserPath(cell);
};

var removeUserPathHead = function removeUserPathHead() {
  _helper.app.userPathHead.classList.remove('user-path', 'head');

  _helper.app.userPathHead.previousUserPath = null;
  _helper.app.userPath = _helper.app.userPath.filter(function (curCell) {
    return curCell !== _helper.app.userPathHead;
  });
...
exports.removeUserPathHead = removeUserPathHead;

var trimUserPath = function trimUserPath(nextCell) {
  if (_helper.app.userPath.includes(nextCell)) {
    // Back-track
    while (_helper.app.userPathHead !== nextCell) {
      removeUserPathHead(_helper.app.userPathHead);
    }
  }
};

exports.trimUserPath = trimUserPath;

var press = function press(e) {
  if (e.keyCode > 36 && e.keyCode < 41 && _helper.app.visitedCells.length <= 0) {
    var nextCell;

    if (e.keyCode === 37) {
      nextCell = _helper.app.userPathHead.neigh['west'];
    } else if (e.keyCode === 38) {
      nextCell = _helper.app.userPathHead.neigh['north'];
    } else if (e.keyCode === 39) {
      nextCell = _helper.app.userPathHead.neigh['east'];
    } else if (e.keyCode === 40) {
      nextCell = _helper.app.userPathHead.neigh['south'];
    } // Once user reach target, they can only backtrack


    if (_helper.app.userPathHead === _helper.app.target && !_helper.app.userPath.includes(nextCell)) {
      return;
    }
...
var setupManualControl = function setupManualControl() {
  document.onkeydown = press;
  addUserPathHead(_helper.app.start);
};

var _default = setupManualControl;
exports.default = _default;
},{"./helper":"helper.js"}],"helper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getLast = exports.randInRange = exports.rand = exports.clearUserPath = exports.clearSearchResult = exports.clearWalls = exports.rerenderPath = exports.startPathFinding = exports.unmarkCellAsWall = exports.markCellAsWall = exports.unmarkCellAsVisited = exports.markCellVisited = exports.delay = exports.app = void 0;

var _dfs = _interopRequireDefault(require("./path-finding/dfs"));

var _bfs = _interopRequireDefault(require("./path-finding/bfs"));

var _manualControl = require("./manual-control");
...
var markCellVisited = function markCellVisited(cell) {
...
exports.markCellVisited = markCellVisited;

var unmarkCellAsVisited = function unmarkCellAsVisited(cell) {
  app.visitedCells = app.visitedCells.filter(function (curCell) {
    return curCell !== cell;
  });
  app.queue = app.queue.filter(function (curCell) {
    return curCell !== cell;
  });
...
exports.unmarkCellAsVisited = unmarkCellAsVisited;

var markCellAsWall = function markCellAsWall(cell) {
  ...
  if (cell !== app.start && cell !== app.target) {
    ...
    if (app.userPath.includes(cell)) {
      var newHead = cell.previousUserPath;
      (0, _manualControl.trimUserPath)(newHead);
...
var clearWalls = function clearWalls() {
  while (app.wallCells.length > 0) {
    var cell = app.wallCells.shift();
    cell.isWall = false;
    cell.classList.remove('wall');
  }
};

exports.clearWalls = clearWalls;
...
var clearSearchResult = function clearSearchResult() {
  ...
  while (app.path.length > 0) {
    var cell = app.path.shift();
    cell.classList.remove('path');
  }

  while (app.visitedCells.length > 0) {
    var _cell = app.visitedCells.shift();

    unmarkCellAsVisited(_cell);
  }
...
var startPathFinding = function startPathFinding() {
  app.state = 'searching';
  clearSearchResult();
...
var rerenderPath = function rerenderPath() {
  if (!app.isFirstRun) {
    startPathFinding();
  }
};

exports.rerenderPath = rerenderPath;
...
},{"./path-finding/dfs":"path-finding/dfs.js","./path-finding/bfs":"path-finding/bfs.js","./manual-control":"manual-control.js"}],"initBoard.js":[function(require,module,exports) {
"use strict";
...
var calculateBoardSize = function calculateBoardSize() {
  var getLength = function getLength(cssAttribute) {
    return _helper.app.board.css(cssAttribute).replace('px', '');
  };

  _helper.app.numCol = Math.floor((getLength('width') - getLength('padding-left') - getLength('padding-right')) / CELL_SIZE);
  _helper.app.numRow = Math.floor((getLength('height') - getLength('padding-top') - getLength('padding-bottom')) / CELL_SIZE);
};
...
var buildBoard = function buildBoard() {
  ...
  for (var i = 0; i < _helper.app.numRow; i++) {
    var colInnerHTML = '';

    for (var j = 0; j < _helper.app.numCol; j++) {
      colInnerHTML += '<div class="cell"></div>';
    }

    rowInnerHTML += "<div class=\"row\">".concat(colInnerHTML, "</div>");
  }

  _helper.app.board.html(rowInnerHTML);
};

var mapBoarArr = function mapBoarArr() {
  var rowEls = $('.row').toArray();
  rowEls.forEach(function (rowEl, rowIndex) {
    var colEls = rowEl.childNodes;
    _helper.app.boardArr[rowIndex] = [];
    colEls.forEach(function (cell, colIndex) {
      _helper.app.boardArr[rowIndex][colIndex] = cell;
      cell.location = {
        rowIndex: rowIndex,
        colIndex: colIndex
      };
      ...
      cell.onmousedown = function () {
        _helper.app.isMouseDown = true;

        if (cell === _helper.app.start) {
          _helper.app.isMovingStart = true;
        } else if (cell === _helper.app.target) {
          _helper.app.isMovingTarget = true;
        } else {
          if (cell.isWall) {
      ...
      cell.onmouseup = function () {
        _helper.app.isMouseDown = false;
        _helper.app.isMovingStart = false;
        _helper.app.isMovingTarget = false;
        _helper.app.isSmashingWall = false;
      };

      cell.onmouseenter = function () {
        if (_helper.app.isMouseDown) {
          if (_helper.app.isMovingStart) {
            _helper.app.start = cell === _helper.app.target ? _helper.app.lastMouseEnteredCell : cell;

            _helper.app.start.classList.add('start');

            _helper.app.start.classList.remove('wall');

            (0, _helper.clearUserPath)();
            (0, _helper.rerenderPath)();
          } else if (_helper.app.isMovingTarget) {
            _helper.app.target = cell === _helper.app.start ? _helper.app.lastMouseEnteredCell : cell;

            _helper.app.target.classList.add('target');

            _helper.app.target.classList.remove('wall');
      ...
      cell.onmouseleave = function () {
        _helper.app.lastMouseEnteredCell = cell;

        if (_helper.app.isMovingStart) {
          _helper.app.start.classList.remove('start');

          if (_helper.app.start.isWall) {
            _helper.app.start.classList.add('wall');
          }

          _helper.app.start = null;
        } else if (_helper.app.isMovingTarget) {
          _helper.app.target.classList.remove('target');

          if (_helper.app.target.isWall) {
            _helper.app.target.classList.add('wall');
          }

          _helper.app.target = null;
        }
      };
...
var mapNeighBours = function mapNeighBours() {
  for (var rowIndex = 0; rowIndex < _helper.app.numRow; rowIndex++) {
    for (var colIndex = 0; colIndex < _helper.app.numCol; colIndex++) {
      ...
      cell.neigh = {
        north: rowIndex !== 0 ? _helper.app.boardArr[rowIndex - 1][colIndex] : null,
        south: rowIndex !== _helper.app.numRow - 1 ? _helper.app.boardArr[rowIndex + 1][colIndex] : null,
        east: colIndex !== _helper.app.numCol - 1 ? _helper.app.boardArr[rowIndex][colIndex + 1] : null,
        west: colIndex !== 0 ? _helper.app.boardArr[rowIndex][colIndex - 1] : null
      };
    }
  }
};
...
var _default = initBoard;
exports.default = _default;
},{"./helper":"helper.js"}],"maze-generation/basic-rand-maze.js":[function(require,module,exports) {
"use strict";
...
var _default = buildBasicRandMaze;
exports.default = _default;
},{"../helper":"helper.js"}],"maze-generation/recursive-division.js":[function(require,module,exports) {
"use strict";
...
var buildSurroundingWalls = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 1:
            if (!(rowIndex < _helper.app.numRow)) {
              _context.next = 15;
              break;
            }
          ...
          case 3:
            if (!(colIndex < _helper.app.numCol)) {
              _context.next = 12;
              break;
            }

            if (!(rowIndex === 0 || rowIndex === _helper.app.numRow - 1 || colIndex === 0 || colIndex === _helper.app.numCol - 1)) {
              _context.next = 9;
              break;
            }
          ...
          case 7:
            cell = _helper.app.boardArr[rowIndex][colIndex];
            (0, _helper.markCellAsWall)(cell);
  ...
  return function buildSurroundingWalls() {
    return _ref.apply(this, arguments);
  };
}();

var buildRecursiveMaze = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return buildSurroundingWalls();

          case 2:
            room = {
              lowerBoundIndex: 1,
              upperBoundIndex: _helper.app.numCol - 2,
              headIndex: 1,
              tailIndex: _helper.app.numRow - 2,
              isVerticalWall: true
            };
            _context2.next = 5;
            return buildWall(room);
  ...
  return function buildRecursiveMaze() {
    return _ref2.apply(this, arguments);
  };
}();

var hasFoundation = function hasFoundation(wallIndex, headIndex, tailIndex, isVerticalWall) {
  return getCell(wallIndex, headIndex - 1, isVerticalWall).isWall || getCell(wallIndex, tailIndex + 1, isVerticalWall).isWall;
};

var generateWallIndex = function generateWallIndex(room) {
  var lowerBoundIndex = room.lowerBoundIndex,
      upperBoundIndex = room.upperBoundIndex,
      headIndex = room.headIndex,
      tailIndex = room.tailIndex,
      isVerticalWall = room.isVerticalWall;
  var hasPotentialWall = false;

  for (var i = lowerBoundIndex + 1; i < upperBoundIndex; i += 2) {
  ...
  var wallIndex = rand((upperBoundIndex - lowerBoundIndex) / 2) * 2 + lowerBoundIndex - 1;

  while (!hasFoundation(wallIndex, headIndex, tailIndex, isVerticalWall)) {
    wallIndex = rand((upperBoundIndex - lowerBoundIndex) / 2) * 2 + lowerBoundIndex - 1;
  }

  return wallIndex;
};

var orientWall = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(room) {
    var lowerBoundIndex, upperBoundIndex, headIndex, tailIndex, isVerticalWall, boundLength, wallLength, sameOrientationAsParent;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            lowerBoundIndex = room.lowerBoundIndex, upperBoundIndex = room.upperBoundIndex, headIndex = room.headIndex, tailIndex = room.tailIndex, isVerticalWall = room.isVerticalWall;
            boundLength = upperBoundIndex - lowerBoundIndex;
            wallLength = tailIndex - headIndex;
            sameOrientationAsParent = true;
  ...
  return function orientWall(_x) {
    return _ref3.apply(this, arguments);
  };
}();

var getCell = function getCell(wallIndex, boundIndex, isVerticalWall) {
  return isVerticalWall ? _helper.app.boardArr[boundIndex][wallIndex] : _helper.app.boardArr[wallIndex][boundIndex];
};

var buildWall = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(room) {
    var lowerBoundIndex, upperBoundIndex, headIndex, tailIndex, isVerticalWall, wallIndex, doorIndex, i, cell;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
          ...
          case 3:
            wallIndex = generateWallIndex(room);
            doorIndex = randInRange(headIndex, tailIndex);
          ...
          case 13:
            cell = getCell(wallIndex, i, isVerticalWall);
          ...
          case 19:
            _context4.next = 21;
            return orientWall(_objectSpread(_objectSpread({}, room), {}, {
              upperBoundIndex: wallIndex - 1
            }));

          case 21:
            _context4.next = 23;
            return orientWall(_objectSpread(_objectSpread({}, room), {}, {
              lowerBoundIndex: wallIndex + 1
            }));
  ...
  return function buildWall(_x2) {
    return _ref4.apply(this, arguments);
  };
}();

var _default = buildRecursiveMaze;
exports.default = _default;
},{"../helper":"helper.js"}],"maze-generation/mgDfs.js":[function(require,module,exports) {
"use strict";
...
var mgDfs = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var cell, stack, curCell, unvisitedNeigh, _iterator3, _step3, dir, _neigh, neigh;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            markAllCellsAsWall();
            cell = _helper.app.boardArr[(0, _helper.rand)(_helper.app.numRow) - 1][(0, _helper.rand)(_helper.app.numCol) - 1];
            stack = [cell];
            (0, _helper.unmarkCellAsWall)(cell);
          ...
          case 4:
            ...
            try {
              for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                dir = _step3.value;
                _neigh = curCell.neigh[dir];

                if (_neigh !== null && _neigh !== void 0 && _neigh.isWall && isOneWayCell(_neigh)) {
                  unvisitedNeigh.push(_neigh);
                }
              }
            } catch (err) {
              _iterator3.e(err);
          ...
          case 12:
            neigh = unvisitedNeigh[(0, _helper.rand)(unvisitedNeigh.length) - 1];
            stack.push(curCell, neigh);
            (0, _helper.unmarkCellAsWall)(neigh);
...
var _basicRandMaze = _interopRequireDefault(require("./maze-generation/basic-rand-maze"));
...
var initControlPanel = function initControlPanel() {
  $('.dropdown-box').on('click', function (e) {
    ...
    var isMenuOpened = parent.classList.contains('opened');

    var _iterator = _createForOfIteratorHelper($('.dropdown-box').toArray()),
        _step;
  ...
  $('#maze-generator-dropdown').on('click', /*#__PURE__*/function () {
  ...
  $('.clear-dropdown').on('click', function (e) {
    if (e.target.classList.contains('dropdown-item')) {
      _helper.app.state = 'finished';
      (0, _helper.clearSearchResult)();
      _helper.app.isFirstRun = true;

      _helper.app.board.removeClass('no-animation');

      clearTimeout(_helper.app.removeAnimationTimeout); // For edge case, when board is cleared during board is waiting for no-animation to be added

      if (e.target.id === 'clear-walls') {
        (0, _helper.clearWalls)();
      }

      _helper.app.state = 'waiting';
    }
  });
};
...
var _initBoard = _interopRequireDefault(require("./initBoard"));

var _initControlPanel = _interopRequireDefault(require("./initControlPanel"));

var _manualControl = _interopRequireDefault(require("./manual-control"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _initBoard.default)();
(0, _initControlPanel.default)();
(0, _manualControl.default)();
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./initBoard":"initBoard.js","./initControlPanel":"initControlPanel.js","./manual-control":"manual-control.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
